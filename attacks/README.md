...
Tool: nmap
Commands:
- `nmap -sS -Pn -p 1-1000 10.10.0.30`
- `nmap -sV --script http-useragent -p 80 10.10.0.30`
...
Tool: hping3
Command:
- `hping3 -S --flood -p 80 10.10.0.30`
Expected Snort behavior:
...
Tool: hping3
Commands:
- `hping3 -F -P -U -p 80 10.10.0.30` (Xmas)
- `hping3 --scan 1-1000 -0 10.10.0.30` (Null)
Expected Snort behavior:
